  ...
  <body>
    ...
    <nav class="navbar navbar-dark bg-inverse bg-inverse-custom navbar-fixed-top">
      <div class="container">
        ...
        <a class="navbar-toggler navbar-toggler-custom hidden-md-up pull-xs-right" data-toggle="collapse" href="login/index.php" aria-expanded="false" aria-controls="collapsingMobileUser">
    ...
    <header class="jumbotron bg-inverse text-xs-center center-vertically" role="banner">
      <div class="container">
        ...
        <h2 class="m-b-3">Bersih, <em>Wangi</em>, dan Ekonomis <br><a href="ui-elements.html" class="jumbolink">powered by UDINUS</a>.</h2>
        <a class="btn btn-secondary-outline m-b-1" href="login/index.php" role="button"><span class="icon-sketch"></span>Gabung Bersama Kami</a>
        <ul class="nav nav-inline social-share">
          <li class="nav-item"><a class="nav-link" href="https://twitter.com/"><span class="icon-twitter"></span> 1024</a></li>
          <li class="nav-item"><a class="nav-link" href="https://web.facebook.com/"><span class="icon-facebook"></span> 562</a></li>
          <li class="nav-item"><a class="nav-link" href="https://id.linkedin.com/"><span class="icon-linkedin"></span> 356</a></li>
        </ul>
      </div>
    </header>
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-lg-7">
            <ul class="nav nav-inline">
              <li class="nav-item">
                <a class="nav-link" href="">Untuk Memenuhi Mata Kuliah Web 2<span class="sr-only"></span></a>
              </li>
            </ul>
          </div>
        </div>
